...
class Solution:
    ...
    def __init__(self, crews, outs, precs):
    ...
    def is_feasible(self):
        ...
        firsts = [o[0] for o in self.precs]
        seconds = [o[1] for o in self.precs]

        for o in self.outs:
            if o in firsts or o in seconds:
                flag = False
                break
        ...
        for prec in self.precs:
            ...
            for o in _o_:
                if f.id_ == o.id_:
                    f.starting_time, f.completion_time = o.starting_time, o.completion_time
                if s.id_ == o.id_:
                    s.starting_time, s.completion_time = o.starting_time, o.completion_time
            if f.completion_time > s.starting_time:
                flag = False
                break
